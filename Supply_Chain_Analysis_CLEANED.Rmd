...
ggplot(data, aes(x = product_cost, y = weight_lbs, color = on_time_delivery)) +
  ...
  annotate("text", x = 2, y = 3.2, label = "Nearly Perfect:\nLow Cost & Weight",
           color = "black", size = 3.1, hjust = 0, fontface = "bold") +
  annotate("rect", xmin = 0, xmax = 175, ymin = 0, ymax = 4,
           alpha = 0.1, fill = "#2CA02C") +
  annotate("text", x = 65, y = 6.5, label = "Perfect Delivery Rate:\n4.5–8 lbs",
           color = "black", size = 3.1, hjust = 0, fontface = "bold") +
  annotate("rect", xmin = 0, xmax = 500, ymin = 4.5, ymax = 8,
...
costs.\
The goal was to analyze supply chain performance data and build a
